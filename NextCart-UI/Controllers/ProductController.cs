...
using ECommerce.BusinessLogic.Interface; // Needed for Guid
        ...
        public async Task<IActionResult> Create(Product product, IFormFile? productImage) // Add IFormFile parameter
        {
            ...
            if (ModelState.IsValid)
            {
                if (productImage != null && productImage.Length > 0)
                {
                    ...
                    string uploadsFolder = "C:\\Users\\2407103\\source\\repos\\NextCart-Ecom-Jess\\NextCart-UI\\wwwroot\\ProductImages";
